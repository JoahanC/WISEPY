...
print("gfortran -o WISE-steep-MCMC-PJDFC ../../MCMC_TPM/WISE-steep-MCMC-PJDFC.f ../../MCMC_TPM/Nedlib.a")
outf.write("gfortran -o WISE-steep-MCMC-PJDFC ../../MCMC_TPM/WISE-steep-MCMC-PJDFC.f ../../MCMC_TPM/Nedlib.a\n")
...
mpcorb=os.popen("grep '^"+objname+"' ../../MCMC_TPM/mpcorb.s3m").readline()
H=mpcorb.split()[8]
G=mpcorb.split()[9]
Herr=0.2
...
if ' ' in lcdb_name:
    lcdb_back=os.popen("grep ' "+lcdb_name+" ' ../../MCMC_TPM/lc_summary.tab").readline()
else:
    lcdb_back=os.popen("grep '^[ ]*"+lcdb_name+" ' ../../MCMC_TPM/lc_summary.tab").readline()
